...
def DifferTime_elemetError(Peak,TieErr, LKErr, BeamErr, BNErr):
    ...
    plt.plot(BNErr[:,0],BNErr[:,Peak],marker = 's',markersize=6,markerfacecolor = 'white',label = 'Beam and Node Boundary Condition')
...
fig1.suptitle(f'Ground Surface Different Boundary Maximum value Compare \n(Middle node)',x=0.50,y =0.95,fontsize = 20)
fig1.text(0.03,0.5, r"Relative Error (%)", va= 'center', rotation= 'vertical', fontsize=20)
fig1.text(0.35,0.04,  f'Mesh size ' + r'$\Delta_c$  $\mathrm {(m)}$', va= 'center', fontsize=20)

ax1 = plt.subplot(311)
DifferTime_elemetError(1,MidTieErr20, MidLKErr20, MidBeamErr20, MidBNErr20)
ax1.set_title(f"SW 20m",fontsize =18, x=0.20, y=0.45)

ax2 = plt.subplot(312)
DifferTime_elemetError(1,MidTieErr10, MidLKErr10, MidBeamErr10, MidBNErr10)
ax2.set_title(f"SW 10m",fontsize =18, x=0.20, y=0.45)

ax3 = plt.subplot(313)
DifferTime_elemetError(1,MidTieErr1, MidLKErr1, MidBeamErr1, MidBNErr1)
ax3.set_title(f"SW 1m",fontsize =18, x=0.20, y=0.45)
...
fig2.suptitle(f'Ground Surface Different Boundary Minimum value Compare \n(Middle node)',x=0.50,y =0.95,fontsize = 20)
fig2.text(0.03,0.5, r"Relative Error (%)", va= 'center', rotation= 'vertical', fontsize=20)
fig2.text(0.35,0.04,  f'Mesh size ' + r'$\Delta_c$  $\mathrm {(m)}$', va= 'center', fontsize=20)

ax4 = plt.subplot(311)
DifferTime_elemetError(2,MidTieErr20, MidLKErr20, MidBeamErr20, MidBNErr20)
ax4.set_title(f"SW 20m",fontsize =18, x=0.20, y=0.45)

ax5 = plt.subplot(312)
DifferTime_elemetError(2,MidTieErr10, MidLKErr10, MidBeamErr10, MidBNErr10)
ax5.set_title(f"SW 10m",fontsize =18, x=0.20, y=0.45)

ax6 = plt.subplot(313)
DifferTime_elemetError(2,MidTieErr1, MidLKErr1, MidBeamErr1, MidBNErr1)
ax6.set_title(f"SW 1m",fontsize =18, x=0.20, y=0.45)
...
x_axis = 0.125
fig3, (ax7,ax8,ax9) = plt.subplots(nrows= 3, ncols=1, sharex=True, figsize=(8,8))
fig3.suptitle(f'Ground Surface Different Boundary Maximum value Compare \n(Three Quarter node)',x=0.50,y =0.95,fontsize = 20)
fig3.text(0.03,0.5, r"Relative Error (%)", va= 'center', rotation= 'vertical', fontsize=20)
fig3.text(0.35,0.04,  f'Mesh size ' + r'$\Delta_c$  $\mathrm {(m)}$', va= 'center', fontsize=20)

ax7 = plt.subplot(311)
DifferTime_elemetError(1,QuaTieErr20, QuaLKErr20, QuaBeamErr20, QuaBNErr20)
ax7.set_title(f"SW 20m",fontsize =18, x=0.20, y=0.45)

ax8 = plt.subplot(312)
DifferTime_elemetError(1,QuaTieErr10, QuaLKErr10, QuaBeamErr10, QuaBNErr10)
ax8.set_title(f"SW 10m",fontsize =18, x=0.20, y=0.45)

ax9 = plt.subplot(313)
DifferTime_elemetError(1,QuaTieErr1, QuaLKErr1, QuaBeamErr1, QuaBNErr1)
ax9.set_title(f"SW 1m",fontsize =18, x=0.20, y=0.45)
...
fig4, (ax10,ax11,ax12) = plt.subplots(nrows= 3, ncols=1, sharex=True, figsize=(8,8))
fig4.suptitle(f'Ground Surface Different Boundary Minimum value Compare \n(Three Quarter node)',x=0.50,y =0.95,fontsize = 20)
fig4.text(0.03,0.5, r"Relative Error (%)", va= 'center', rotation= 'vertical', fontsize=20)
fig4.text(0.35,0.04,  f'Mesh size ' + r'$\Delta_c$  $\mathrm {(m)}$', va= 'center', fontsize=20)

ax10 = plt.subplot(311)
DifferTime_elemetError(2,QuaTieErr20, QuaLKErr20, QuaBeamErr20, QuaBNErr20)
ax10.set_title(f"SW 20m",fontsize =18, x=0.20, y=0.45)

ax11 = plt.subplot(312)
DifferTime_elemetError(2,QuaTieErr10, QuaLKErr10, QuaBeamErr10, QuaBNErr10)
ax11.set_title(f"SW 10m",fontsize =18, x=0.20, y=0.45)

ax12 = plt.subplot(313)
DifferTime_elemetError(2,QuaTieErr1, QuaLKErr1, QuaBeamErr1, QuaBNErr1)
ax12.set_title(f"SW 1m",fontsize =18, x=0.20, y=0.45)
