...
fig1, axes = plt.subplots(nrows= 3, ncols=2, sharex=True, figsize=(12,8))
...
fig1.text(0.48,0.05, 'time (s)', va= 'center', fontsize=20)
...
# fig1.suptitle(f'{Boundary1} (Three Quarter node)',x=0.5,y =0.95,fontsize = 20)
# fig1.text(0.03,0.5, 'relative error (%)', va= 'center', rotation= 'vertical', fontsize=20)
