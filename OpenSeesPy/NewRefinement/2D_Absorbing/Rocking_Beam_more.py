...
Choose_Wave = f"NewMark_Linear/Rocking_Beam" # Pwave ; Vertical / Horizon / Rocking  
HZ = 80
...
# -======= Tie Condition =======
Found_Left = BotNDash_Start + 2*(nx+1) # Left node 1
Found_Left2 = Found_Left + 1  # Left node 2
Found_Mid = Found_Left2 + 1

Found_Right2 = Found_Mid + 1 # Right node 2
Found_Right = Found_Right2 + 1 # Right node 1

FoundLeft_Ele = BotNEle_End + 1
FoundLeft_Ele2 = FoundLeft_Ele + 1

FoundRight_Ele = FoundLeft_Ele2 + 1
FoundRight_Ele2 = FoundRight_Ele + 1
...
node(Found_Left2, (soilwidth/2)-0.25, soilLength)

node(Found_Mid, (soilwidth/2), soilLength)

node(Found_Right2, (soilwidth/2)+0.25, soilLength)
node(Found_Right, (soilwidth/2)+0.5, soilLength)
print(f'Found_Left = {Found_Left}, Found_Mid = {Found_Mid}, Found_Right = {Found_Right}')
# printModel('-node', Found_Left, Found_Left2, Found_Mid, Found_Right2, Found_Right)

fix(Found_Left,0,0,1)
fix(Found_Left2,0,0,1)
fix(Found_Mid,0,0,1)
fix(Found_Right2,0,0,1)
fix(Found_Right,0,0,1)
# ---------- Top Foundation Beam Element ----------------------
element('elasticBeamColumn', FoundLeft_Ele, Found_Left, Found_Left2, A,E1,Iz, 1, '-release', 3)
element('elasticBeamColumn', FoundLeft_Ele2, Found_Left2, Found_Mid, A,E1,Iz, 1, '-release', 3)

element('elasticBeamColumn', FoundRight_Ele, Found_Mid, Found_Right2, A,E1,Iz, 1, '-release', 3)
element('elasticBeamColumn', FoundRight_Ele2, Found_Right2, Found_Right, A,E1,Iz, 1, '-release', 3)
# --------- Top Beam and Soil BC -----------------
equalDOF(TopLeft_Node, Found_Left, 1,2)
equalDOF(TopLeft_Node+1, Found_Left2, 1,2)

equalDOF(TopMid_Node, Found_Mid, 1,2)

equalDOF(TopRight_Node-1, Found_Right2, 1,2)
...
eleLoad('-ele', FoundLeft_Ele, '-type','-beamUniform', -Distribute_Force, 0, aOverL_Left, bOverL_Left, (Distribute_Force/2), 0) # i to j end
eleLoad('-ele', FoundLeft_Ele2, '-type','-beamUniform', -(Distribute_Force/2), 0, aOverL_Left, bOverL_Left, 0, 0) # i to j end

eleLoad('-ele', FoundRight_Ele, '-type','-beamUniform',0, 0, aOverL_Right, bOverL_Right, +(Distribute_Force/2), 0) # i to j end
eleLoad('-ele', FoundRight_Ele2, '-type','-beamUniform',+(Distribute_Force/2), 0, aOverL_Right, bOverL_Right, Distribute_Force, 0) # i to j end
