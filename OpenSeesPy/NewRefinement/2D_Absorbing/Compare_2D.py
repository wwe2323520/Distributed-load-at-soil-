...
Force_Condition = f'Change_Dw/Vertical' # Vertical; Horizon; Distributed_Rocking; Point_Rocking
...
fig1.text(0.55,0.85, r"$\mathrm {Vertical}$ $(t_{d} = 1/20)$", color = "blue", fontsize=22)
...
# fig2.text(0.55,0.85, r"$\mathrm {Rocking}$ $(t_{d} = 1/10)$", color = "blue", fontsize=22)
...
# fig3.text(0.55,0.85, r"$\mathrm {Rocking}$ $(t_{d} = 1/10)$", color = "blue", fontsize=22)
...
fig4.text(0.55,0.85, r"$\mathrm {Vertical}$ $(t_{d} = 1/20)$", color = "blue", fontsize=22)
...
# fig5.text(0.55,0.85, r"$\mathrm {Rocking}$ $(t_{d} = 1/10)$", color = "blue", fontsize=22)
# fig5.text(0.03,0.5, r"$\mathrm {Velocity}$  $v_x$  $\mathrm {(m/s)}$", va= 'center', rotation= 'vertical', fontsize=20)
...
# fig6.text(0.55,0.85, r"$\mathrm {Rocking}$ $(t_{d} = 1/10)$", color = "blue", fontsize=22)
# fig6.text(0.03,0.5, r"$\mathrm {Velocity}$  $v_x$  $\mathrm {(m/s)}$", va= 'center', rotation= 'vertical', fontsize=20)
...
# fig7.text(0.15,0.85, r"$\mathrm {Rocking}$ $(t_{d} = 1/40)$", color = "blue", fontsize=22)
...
# ax28.set_title(r"$w=$ $\mathrm{2m}$",fontsize =23, x=0.15, y=0.70)
...
# fig8.text(0.15,0.83, r"$\mathrm {Rocking}$ $(t_{d} = 1/40)$", color = "blue", fontsize=22)
...
# ax30.set_title(r"$w=$ $\mathrm{10m}$",fontsize =23,  x=0.15, y=0.80)
...
# ax31.set_title(r"$w=$ $\mathrm{5m}$",fontsize =23,  x=0.15, y=0.60)
...
# ax32.set_title(r"$w=$ $\mathrm{2m}$",fontsize =23,  x=0.15, y=0.55)
...
# fig9.text(0.15,0.85, r"$\mathrm {Rocking}$ $(t_{d} = 1/40)$", color = "blue", fontsize=22)
...
# ax34.set_title(r"$w=$ $\mathrm{10m}$",fontsize =23, x=0.80, y=0.20)
...
# ax35.set_title(r"$w=$ $\mathrm{5m}$",fontsize =23, x=0.80, y=0.20)
...
# ax36.set_title(r"$w=$ $\mathrm{2m}$",fontsize =23, x=0.80, y=0.20)
...
# fig10.text(0.15,0.85, r"$\mathrm {Rocking}$ $(t_{d} = 1/40)$", color = "blue", fontsize=22)
...
# fig11.text(0.15,0.85, r"$\mathrm {Vertical}$ $(t_{d} = 1/40)$", color = "blue", fontsize=22)
...
# ax41.set_title(r"$w$ $\mathrm{20m}$",fontsize =23,  x=0.15, y=0.55)
...
# ax42.set_title(r"$w$ $\mathrm{10m}$",fontsize =23, x=0.15, y=0.80)
...
# ax43.set_title(r"$w$ $\mathrm{5m}$",fontsize =23, x=0.15, y=0.35)
...
# fig12.text(0.50,0.85, r"$\mathrm {Rocking}$ $(t_{d} = 1/40)$", color = "blue", fontsize=22)
...
# ax45.set_title(r"$w=$ $\mathrm{20m}$",fontsize =23, x=0.70, y=0.60)
...
# ax46.set_title(r"$w=$ $\mathrm{10m}$",fontsize =23, x=0.15, y=0.30)
...
# ax47.set_title(r"$w=$ $\mathrm{5m}$",fontsize =23, x=0.15, y=0.15)
...
# fig12.legend(lines, labels, loc = (0.78,0.80),prop=font_props)
...
# fig13.text(0.60,0.85, r"$\mathrm {Rocking}$ $(t_{d} = 1/40)$", color = "blue", fontsize=22)

# fig13.text(0.045,0.5, '(t = 0.10~0.20s) Peak Velocity Error: '+ r"$NE_{Min}$" + r" (%)", va= 'center', rotation= 'vertical', fontsize=20)
...
# ax49.set_title(r"$w=$ $\mathrm{20m}$",fontsize =23, x=0.80, y=0.50)

# ax49.set_xscale('log', base=10)
# ax49.set_yscale('log', base=10)
# ax49.tick_params(axis = 'y', which = 'both', labelsize = 17)
...
# ax50.tick_params(axis = 'y', which = 'both', labelsize = 17)
...
# ax51.set_title(r"$w=$ $\mathrm{5m}$",fontsize =23, x=0.15, y=0.15)

# ax51.set_xscale('log', base=10)
# ax51.set_yscale('log', base=10)
# ax51.tick_params(axis = 'y', which = 'both', labelsize = 17)
...
# # ax52.tick_params(axis = 'y', which = 'both', labelsize = 17)
...
# fig13.legend(lines, labels, loc = (0.78,0.60),prop=font_props)
