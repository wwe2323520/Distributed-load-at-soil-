...
def Differ_BCVel(Tie, LKDash, BeamType1):
    ...
    plt.xticks(fontsize = 22, fontweight='bold', color='black') # 18 / 15
    plt.yticks(fontsize = 17, fontweight='bold', color='black') # 25 / 17
    ...
    ax.yaxis.set_major_locator(ticker.MultipleLocator(0.02)) # 0.50 / 1.0
...
# fig1.text(0.47,0.85, r"$\mathrm {Vertical\;Loading}$ ($t_d=0.1$ $\mathrm {s}$)", color = "black", fontsize=18)
# fig1.text(0.01,0.5, r"$\mathrm {Velocity}$  $v_y$  $\mathrm {(m/s)}$", va= 'center', rotation= 'vertical', fontsize=27)
...
# fig2.text(0.45,0.85, r"$\mathrm {Vertical\;Loading}$ ($t_d=0.05$ $\mathrm {s}$)", color = "black", fontsize=18)
# fig2.text(0.01,0.5, r"$\mathrm {Velocity}$  $v_y$  $\mathrm {(m/s)}$", va= 'center', rotation= 'vertical', fontsize=27)
...
# fig3.text(0.43,0.85, r"$\mathrm {Vertical\;Loading}$ ($t_d=0.025$ $\mathrm {s}$)", color = "black", fontsize=18)
# fig3.text(0.01,0.5, r"$\mathrm {Velocity}$  $v_y$  $\mathrm {(m/s)}$", va= 'center', rotation= 'vertical', fontsize=27)
...
# fig4.text(0.41,0.85, r"$\mathrm {Vertical\;Loading}$ ($t_d=0.0125$ $\mathrm {s}$)", color = "black", fontsize=18)
# fig4.text(0.01,0.5, r"$\mathrm {Velocity}$  $v_y$  $\mathrm {(m/s)}$", va= 'center', rotation= 'vertical', fontsize=27)
...
# fig5.text(0.47,0.85, r"$\mathrm {Vertical\;Loading}$ ($t_d=0.1$ $\mathrm {s}$)", color = "black", fontsize=18)
# fig5.text(0.01,0.5, r"$\mathrm {Velocity}$  $v_y$  $\mathrm {(m/s)}$", va= 'center', rotation= 'vertical', fontsize=27)
...
# fig6.text(0.45,0.85, r"$\mathrm {Vertical\;Loading}$ ($t_d=0.05$ $\mathrm {s}$)", color = "black", fontsize=18)
# fig6.text(0.01,0.5, r"$\mathrm {Velocity}$  $v_y$  $\mathrm {(m/s)}$", va= 'center', rotation= 'vertical', fontsize=27)
...
# fig7.text(0.43,0.85, r"$\mathrm {Vertical\;Loading}$ ($t_d=0.025$ $\mathrm {s}$)", color = "black", fontsize=18)
# fig7.text(0.01,0.5, r"$\mathrm {Velocity}$  $v_y$  $\mathrm {(m/s)}$", va= 'center', rotation= 'vertical', fontsize=27)
...
# fig8.text(0.41,0.85, r"$\mathrm {Vertical\;Loading}$ ($t_d=0.0125$ $\mathrm {s}$)", color = "black", fontsize=18)
# fig8.text(0.01,0.5, r"$\mathrm {Velocity}$  $v_y$  $\mathrm {(m/s)}$", va= 'center', rotation= 'vertical', fontsize=27)
...
# fig10.text(0.13,0.72, "(Node 1 m away from the midpoint)", color = "black", fontsize=20)
# fig10.text(0.13,0.75, r"$\mathrm {Vertical\;Loading}$", color = "black", fontsize=23)
...
def Tie_RelativeError(TieErr2, TieErr5, TieErr10, TieErr20):
    ...
    plt.text(0.02, 0.08,r"$\mathrm {Vertical\;Loading}$", color='black', fontsize = 25, transform=plt.gca().transAxes)
    plt.text(0.02, 0.03,'Tie', color='black', fontsize = 30, transform=plt.gca().transAxes)
...
# fig14.text(0.13,0.66, "(Node 1 m away from the midpoint)", color = "black", fontsize=20) # 0.66 / 0.82
# fig14.text(0.13,0.69, r"$\mathrm {Vertical\;Loading}$", color = "black", fontsize=18) # 0.69    / 0.85
...
# fig17.text(0.13,0.85, r"$\mathrm {Vertical\;Loading}$", color = "black", fontsize=18)
...
# fig18.text(0.13,0.85, r"$\mathrm {Vertical\;Loading}$", color = "black", fontsize=18)
...
def Tie_PeakRelative(TieErr2, TieErr5, TieErr10, TieErr20):
    ...
    plt.ylim(0, 80)  # Vertical: Mid = 0, 70 / 1m away = 0, 210 ; Rocking = -2, 150; Horizon = 0, 25/60
    # plt.grid(True)
    # ========== set up figure thick ============================
    bwidth = 2
    TK = plt.gca()
...
# fig22.text(0.13,0.85, r"$\mathrm {Vertical\;Loading}$", color = "black", fontsize=18)
