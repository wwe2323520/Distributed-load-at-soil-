...
Choose_Wave = f"NoChange_Dw/Horizon" # Pwave ; Vertical / Horizon / Rocking  NoChange_Dw/Vertical
# HZ = 20
...
for i in range(len(Width)):
    ...
    for j in range(len(Force_HZ)):
        TimeSeries_Num = int(Top_Stime[j]) # PtimeNum / StimeNum ; Top_Ptime / Top_Stime
        HZ = int(Force_HZ[j])
