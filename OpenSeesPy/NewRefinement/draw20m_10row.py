...
file2 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele801.out"
file3 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele1441.out"
...
file8 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele881.out"
file9 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele1521.out"
...
file14 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele960.out"
file15 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele1600.out"
...
#----------------------------- Left column file -----------------------------------
ele1 = rdnumpy(file1)
ele801 = rdnumpy(file2)
ele1441 = rdnumpy(file3)

vel1 = rdnumpy(file4)
vel806 = rdnumpy(file5)
vel1611 = rdnumpy(file6)
#----------------------------- Center column file -----------------------------------
ele81 = rdnumpy(file7)
ele881 = rdnumpy(file8)
ele1521 = rdnumpy(file9)

vel81 = rdnumpy(file10)
vel886 = rdnumpy(file11)
vel1691 = rdnumpy(file12)
#----------------------------- Right column file -----------------------------------
ele160 = rdnumpy(file13)
ele960 = rdnumpy(file14)
ele1600 = rdnumpy(file15)

vel161 = rdnumpy(file16)
vel966 = rdnumpy(file17)
vel1771 = rdnumpy(file18)
...
x_axis = 0.05
draw_stress("Left side stress",ele1,ele801,ele1441,"ele1","ele801","ele1441")
ax1 = plt.gca()
...
draw_stress("Center side stress",ele81,ele881,ele1521,"ele81","ele881","ele1521")
ax3 = plt.gca()
...
draw_stress("Right side stress",ele160,ele960,ele1600,"ele160","ele960","ele1600")
ax2 = plt.gca()
...
draw_Vel("Left side Velocity",vel1,vel806,vel1611,"vel1","vel806","vel1611")
ax4 = plt.gca()
...
draw_Vel("Center side Velocity",vel81,vel886,vel1691,"vel81","vel886","vel1691")
ax6 = plt.gca()
...
draw_Vel("Right side Velocity",vel161,vel966,vel1771,"vel161","vel966","vel1771")
ax5 = plt.gca()
