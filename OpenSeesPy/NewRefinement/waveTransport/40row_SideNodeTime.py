...
plt.plot(total_time,SNodeforce_x[:,20],label ='Node 20', marker='x', markevery=100)
plt.plot(total_time,SNodeforce_x[:,40],label ='Node 41', marker='d', markevery=100)

# # ----- Swave sigma_xy -------------
# plt.plot(total_time,SSideforce_y[:,0],label ='Element 1', marker='o', markevery=100)
# plt.plot(total_time,SSideforce_y[:,20],label ='Element 5', marker='x', markevery=100)
# plt.plot(total_time,SSideforce_y[:,39],label ='Element 10', marker='d', markevery=100)
...
# plt.plot(total_Transport,XNodeIn[:,20],label ='Node 5',marker='d', markevery=100)
# plt.plot(total_Transport,XNodeIn[:,40],label ='Node 11',marker='x', markevery=100)
# plt.legend(loc='upper right',fontsize=18)
# plt.xlim(0,30.0)
# plt.xticks(fontsize = 15)
# plt.yticks(fontsize = 15)
...
# plt.plot(total_Transport,XNodeOut[:,20],label ='Node 10',marker='d', markevery=100)
# plt.plot(total_Transport,XNodeOut[:,40],label ='Node 20',marker='x', markevery=100)
# plt.xlim(0,30.0)
