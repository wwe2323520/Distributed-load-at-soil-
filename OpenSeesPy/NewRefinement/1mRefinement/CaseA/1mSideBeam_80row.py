...
# ==================== Side Beam node (1423~1503 / 1504~1584) ====================
for i in range(ny+1):
# ----- Left Side: 1423~1503 -----------------
    node(1423+i, 0.0, yMesh*i)
    fix(1423+i,0,0,1)
# ----- Right Side: 1504~1584 -----------------
    node(1504+i,1.0,yMesh*i)
    fix(1504+i,0,0,1)

# ------------  Beam Element: 991 ~ 1070 / 1071 ~ 1150 ------------------
for j in range(ny):
# ----- Left Side Beam:991 ~ 1070 -----------------
    element('elasticBeamColumn', 991+j, 1423+j, 1424+j, A,E1,Iz, 1, '-release', 3)
# ----- Right Side Beam:1071 ~ 1150 -----------------
    element('elasticBeamColumn', 1071+j, 1504+j, 1505+j, A,E1,Iz, 1, '-release', 3)

# --------- Side Beam and Soil BC -----------------
for j in range(ny+1):
    equalDOF(1+9*j,1423+j,1,2)
    equalDOF(9+9*j,1504+j,1,2)
...
# ---------- Distributed at Left Side Beam ----------------------
    eleLoad('-ele',991+g, '-type', '-beamUniform',-20,0)  # for local axes Wy -
# ---------- Distributed at Right Side Beam ----------------------
    eleLoad('-ele',1071+g, '-type', '-beamUniform',-20,0)   # for local axes Wy +
...
# ---------- Distributed at Left Side Beam ----------------------
    eleLoad('-ele',991+g, '-type', '-beamUniform',0,+20,0)  # for local axes Wx +
# ---------- Distributed at Right Side Beam ----------------------
    eleLoad('-ele',1071+g, '-type', '-beamUniform',0,-20,0)   # for local axes Wx -
