...
node(BotNode, 0.0, 0.0)
node(BotNode+1, soilwidth, 0.0)
node(BotNode+2, 0.0, -0.125)
node(BotNode+3, soilwidth, -0.125)

element('quad', BotEle, BotNode+2, BotNode+3, BotNode+1, BotNode ,*eleArgs)

# ========= soil with  virtual Quad element have same dof ===================
equalDOF(n1, BotNode, 1,2)
equalDOF(n1+1, BotNode+1, 1,2)

# =========== Bottom Beam element ===================
BeamNode_Start = BotNode + 4
