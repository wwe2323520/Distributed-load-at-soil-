...
# ----- Swave eta_p*(Vx) taux --------------------------             
            SSideforce_x[to+t,End_Ele-g] = SSideforce_x[to+t,End_Ele-g] + (ForceX_Cofficient *XOut[t-to,End_Ele-g])
...
# num_rows, num_cols = SSideforce_y.shape# SNodeforce_y.shape
# # # 建立資料夾
# # ---------- Swave ---------------
# S_folder_name_x = "Ray_S_Sideforce_80rowx" # "S_Nodeforce_80rowx"
...
# S_folder_name_y = "Ray_S_Sideforce_80rowy" # S_Sideforce_y
# os.makedirs(S_folder_name_y, exist_ok=True)
# # 逐一建立txt檔案並放入資料夾
# for col in range(num_cols):
...
# plt.plot(total_time,SSideforce_x[:,40],label ='Center Element', marker='x', markevery=100)
# plt.plot(total_time,SSideforce_x[:,79],label ='Top Element', marker='d', markevery=100)
...
plt.plot(total_time,SSideforce_y[:,40],label ='Center Element', marker='x', markevery=100)
plt.plot(total_time,SSideforce_y[:,79],label ='Top Element', marker='d', markevery=100)
