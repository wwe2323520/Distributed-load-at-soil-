...
file3 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele1521.out"
...
file8 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele841.out"
file9 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele1561.out"
...
file14 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele880.out"
...
ele1521 = rdnumpy(file3)

vel1 = rdnumpy(file4)
vel811 = rdnumpy(file5)
vel1621 = rdnumpy(file6)
#----------------------------- Center column file -----------------------------------
ele41 = rdnumpy(file7)
ele841 = rdnumpy(file8)
ele1561 = rdnumpy(file9)

vel41 = rdnumpy(file10)
vel851 = rdnumpy(file11)
vel1661 = rdnumpy(file12)
#----------------------------- Right column file -----------------------------------
ele80 = rdnumpy(file13)
ele880 = rdnumpy(file14)
ele1600 = rdnumpy(file15)

vel81 = rdnumpy(file16)
vel891 = rdnumpy(file17)
vel1701 = rdnumpy(file18)
...
x_axis = 0.05
draw_stress("Left side stress",ele1,ele801,ele1521,"ele1","ele801","ele1521")
ax1 = plt.gca()
...
draw_stress("Center side stress",ele41,ele841,ele1561,"ele41","ele841","ele1561")
ax3 = plt.gca()
...
draw_stress("Right side stress",ele80,ele880,ele1600,"ele80","ele880","ele1600")
ax2 = plt.gca()
...
draw_Vel("Left side Velocity",vel1,vel811,vel1621,"vel1","vel811","vel1621")
ax4 = plt.gca()
...
draw_Vel("Center side Velocity",vel41,vel851,vel1661,"vel41","vel851","vel1661")
ax6 = plt.gca()
...
draw_Vel("Right side Velocity",vel81,vel891,vel1701,"vel81","vel891","vel1701")
ax5 = plt.gca()
