...
# ==================== Side Beam node (14495~14575 / 14576~14656) ====================
for i in range(ny+1):
# ----- Left Side: 14495~14575 -----------------
    node(14495+i, 0.0, yMesh*i)
    fix(14495+i,0,0,1)
# ----- Right Side: 14576~14656 -----------------
    node(14576+i, 20.0,yMesh*i)
    fix(14576+i,0,0,1)

# ------------  Beam Element: 13607 ~ 13686 / 13687 ~ 13766 ------------------
for j in range(ny):
# ----- Left Side Beam:13607 ~ 13686 -----------------
    element('elasticBeamColumn', 13607+j, 14495+j, 14496+j, A,E1,Iz, 1, '-release', 3)
# ----- Right Side Beam:13687 ~ 13766 -----------------
    element('elasticBeamColumn', 13687+j, 14576+j, 14577+j, A,E1,Iz, 1, '-release', 3)

# --------- Side Beam and Soil BC -----------------
for j in range(ny+1):
    equalDOF(1+161*j,14495+j,1,2)
    equalDOF(161+161*j,14576+j,1,2)
...
# ---------- Distributed at Left Side Beam ----------------------
    eleLoad('-ele',13607+g, '-type', '-beamUniform',-20,0)  # for local axes Wy -
# ---------- Distributed at Right Side Beam ----------------------
    eleLoad('-ele',13687+g, '-type', '-beamUniform',-20,0)   # for local axes Wy +
...
# ---------- Distributed at Left Side Beam ----------------------
    eleLoad('-ele',13607+g, '-type', '-beamUniform',0,+20,0)  # for local axes Wx +
# ---------- Distributed at Right Side Beam ----------------------
    eleLoad('-ele',13687+g, '-type', '-beamUniform',0,-20,0)   # for local axes Wx -
