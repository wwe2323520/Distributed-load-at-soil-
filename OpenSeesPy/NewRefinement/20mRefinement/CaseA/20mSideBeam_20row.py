...
# ==================== Side Beam node (4355~4375 / 4376~4396) ====================
for i in range(ny+1):
# ----- Left Side: 4355~4375 -----------------
    node(4355+i, 0.0, yMesh*i)
    fix(4355+i,0,0,1)
# ----- Right Side: 4376~4396 -----------------
    node(4376+i,20.0,yMesh*i)
    fix(4376+i,0,0,1)

# ------------  Beam Element: 3767 ~ 3786 / 3787 ~ 3806 ------------------
for j in range(ny):
# ----- Left Side Beam:3767 ~ 3786 -----------------
    element('elasticBeamColumn', 3767+j, 4355+j, 4356+j, A,E1,Iz, 1, '-release', 3)
# ----- Right Side Beam:3787 ~ 3806 -----------------
    element('elasticBeamColumn', 3787+j, 4376+j, 4377+j, A,E1,Iz, 1, '-release', 3)

# --------- Side Beam and Soil BC -----------------
for j in range(ny+1):
    equalDOF(1+161*j,4355+j,1,2)
    equalDOF(161+161*j,4376+j,1,2)
...
# ---------- Distributed at Left Side Beam ----------------------
    eleLoad('-ele',3767+g, '-type', '-beamUniform',-20,0)  # for local axes Wy -
# ---------- Distributed at Right Side Beam ----------------------
    eleLoad('-ele',3787+g, '-type', '-beamUniform',-20,0)   # for local axes Wy +
...
# ---------- Distributed at Left Side Beam ----------------------
    eleLoad('-ele',3767+g, '-type', '-beamUniform',0,+20,0)  # for local axes Wx +
# ---------- Distributed at Right Side Beam ----------------------
    eleLoad('-ele',3787+g, '-type', '-beamUniform',0,-20,0)   # for local axes Wx -
