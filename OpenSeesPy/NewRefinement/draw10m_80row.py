...
file3 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele6321.out"
...
file8 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele3241.out"
file9 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele6361.out"
...
file14 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele3280.out"
...
ele6321 = rdnumpy(file3)

vel1 = rdnumpy(file4)
vel3241 = rdnumpy(file5)
vel6481 = rdnumpy(file6)
#----------------------------- Center column file -----------------------------------
ele41 = rdnumpy(file7)
ele3241 = rdnumpy(file8)
ele6361 = rdnumpy(file9)

vel41 = rdnumpy(file10)
vel3281 = rdnumpy(file11)
vel6521 = rdnumpy(file12)
#----------------------------- Right column file -----------------------------------
ele80 = rdnumpy(file13)
ele3280 = rdnumpy(file14)
ele6400 = rdnumpy(file15)

vel81 = rdnumpy(file16)
vel3321 = rdnumpy(file17)
vel6561 = rdnumpy(file18)
...
x_axis = 0.05
draw_stress("Left side stress",ele1,ele3201,ele6321,"ele1","ele3201","ele6321")
ax1 = plt.gca()
...
draw_stress("Center side stress",ele41,ele3241,ele6361,"ele41","ele3241","ele6361")
ax3 = plt.gca()
...
draw_stress("Right side stress",ele80,ele3280,ele6400,"ele80","ele3280","ele6400")
ax2 = plt.gca()
