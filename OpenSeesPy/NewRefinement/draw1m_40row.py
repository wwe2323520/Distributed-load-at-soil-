...
file2 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele161.out"
file3 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele313.out"
...
file8 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele165.out"
file9 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele317.out"
...
file14 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele168.out"
file15 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele320.out"
...
#----------------------------- Left column file -----------------------------------
ele1 = rdnumpy(file1)
ele161 = rdnumpy(file2)
ele313 = rdnumpy(file3)

vel1 = rdnumpy(file4)
vel181 = rdnumpy(file5)
vel361 = rdnumpy(file6)
#----------------------------- Center column file -----------------------------------
ele5 = rdnumpy(file7)
ele165 = rdnumpy(file8)
ele317 = rdnumpy(file9)

vel5 = rdnumpy(file10)
vel185 = rdnumpy(file11)
vel365 = rdnumpy(file12)
#----------------------------- Right column file -----------------------------------
ele8 = rdnumpy(file13)
ele168 = rdnumpy(file14)
ele320 = rdnumpy(file15)

vel9 = rdnumpy(file16)
vel189 = rdnumpy(file17)
vel369 = rdnumpy(file18)
...
x_axis = 0.05
draw_stress("Left side stress",ele1,ele161,ele313,"ele1","ele161","ele313")
ax1 = plt.gca()
...
draw_stress("Center side stress",ele5,ele165,ele317,"ele5","ele165","ele317")
ax3 = plt.gca()
...
draw_stress("Right side stress",ele8,ele168,ele320,"ele8","ele168","ele320")
ax2 = plt.gca()
...
draw_Vel("Left side Velocity",vel1,vel181,vel361,"vel1","vel181","vel361")
ax4 = plt.gca()
...
draw_Vel("Center side Velocity",vel5,vel185,vel365,"vel5","vel185","vel365")
ax6 = plt.gca()
...
draw_Vel("Right side Velocity",vel9,vel189,vel369,"vel9","vel189","vel369")
ax5 = plt.gca()
