...
Integrator = "Central"
# Boundary = f"Pwave/W_2m/TieBC_80row"
...
# ================= Build Boundary File =====================1D_Transport/{Boundary}
...
timeSeries('Path',702, '-filePath','TimeSeries/Pwave_Time/fp_Dt0.1.txt','-dt',3.125e-05)
