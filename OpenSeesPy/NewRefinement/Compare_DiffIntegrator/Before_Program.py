...
Integrator = "New_Constant"

# Depth = np.array([0.25, 0.5, 1.25, 2.5]) #0.25, 0.5, 1.25, 2.5

# a_cofficient = np.array([1.2,1.4,1.6,1.8]) #1.0,2.0,3.0,4.0
# b_cofficient = np.array([1.2,1.4,1.6,1.8]) #1.0,2.0,3.0,4.0
...
# ---- Calculate dt -------------------
Dt_Size = 0.1 # C = 0.1, 0.4, 0.8, 1.0, 2.0
Vp = 400  # 374.166 m/s (nu = 0.3) ; 400 m/s (nu =1/3)
Vs = 200  # m/s 

yMesh = soilLength/ny # Y row MeshSize
dcell = yMesh / Vp 
dt = dcell*Dt_Size
print(f"Pwave travel each ele = {dcell} ;dt = {dt}, yMesh= {yMesh}")
# ======= Totla Analysis Time ============================
...
# ================= Build Boundary File =====================
path1 = f'D:/shiang/opensees/20220330/OpenSeesPy/Test_Integrator/{Integrator}/Velocity' # f'E:/unAnalysisFile/RayleighDashpot/{Boundary}/DepthTest/H{Applt_D}/Ca{akz}_Cb{bkz}/Velocity'
path2 = f'D:/shiang/opensees/20220330/OpenSeesPy/Test_Integrator/{Integrator}/Stress' # f'E:/unAnalysisFile/RayleighDashpot/{Boundary}/DepthTest/H{Applt_D}/Ca{akz}_Cb{bkz}/Stress'
...
# recorder('Element', '-file', f'ele{CenterE_Center}.out', '-time', '-ele',CenterE_Center, 'material ',1,'stresses')
# recorder('Element', '-file', f'ele{UpperE_Center}.out', '-time', '-ele',UpperE_Center, 'material ',1,'stresses')
...
# recorder('Element', '-file', f'ele{CenterE_Right}.out', '-time', '-ele',CenterE_Right, 'material ',1,'stresses')
# recorder('Element', '-file', f'ele{UpperE_Right}.out', '-time', '-ele',UpperE_Right, 'material ',1,'stresses')
