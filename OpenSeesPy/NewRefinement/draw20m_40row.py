...
file2 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele3201.out"
file3 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele6241.out"
...
file8 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele3281.out"
file9 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele6321.out"
...
file14 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele3360.out"
file15 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele6400.out"
...
#----------------------------- Left column file -----------------------------------
ele1 = rdnumpy(file1)
ele3201 = rdnumpy(file2)
ele6241 = rdnumpy(file3)

vel1 = rdnumpy(file4)
vel3221 = rdnumpy(file5)
vel6441 = rdnumpy(file6)
#----------------------------- Center column file -----------------------------------
ele81 = rdnumpy(file7)
ele3281 = rdnumpy(file8)
ele6321 = rdnumpy(file9)

vel81 = rdnumpy(file10)
vel3301 = rdnumpy(file11)
vel6521 = rdnumpy(file12)
#----------------------------- Right column file -----------------------------------
ele160 = rdnumpy(file13)
ele3360 = rdnumpy(file14)
ele6400 = rdnumpy(file15)

vel161 = rdnumpy(file16)
vel3381 = rdnumpy(file17)
vel6601 = rdnumpy(file18)
...
x_axis = 0.05
draw_stress("Left side stress",ele1,ele3201,ele6241,"ele1","ele3201","ele6241")
ax1 = plt.gca()
...
draw_stress("Center side stress",ele81,ele3281,ele6321,"ele81","ele3281","ele6321")
ax3 = plt.gca()
...
draw_stress("Right side stress",ele160,ele3360,ele6400,"ele160","ele3360","ele6400")
ax2 = plt.gca()
...
draw_Vel("Left side Velocity",vel1,vel3221,vel6441,"vel1","vel3221","vel6441")
ax4 = plt.gca()
...
draw_Vel("Center side Velocity",vel81,vel3301,vel6521,"vel81","vel3301","vel6521")
ax6 = plt.gca()
...
draw_Vel("Right side Velocity",vel161,vel3381,vel6601,"vel161","vel3381","vel6601")
ax5 = plt.gca()
