...
file3 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele3121.out"
...
file8 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele1641.out"
file9 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele3161.out"
...
file14 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele1680.out"
...
ele3121 = rdnumpy(file3)

vel1 = rdnumpy(file4)
vel1621 = rdnumpy(file5)
vel3241 = rdnumpy(file6)
#----------------------------- Center column file -----------------------------------
ele41 = rdnumpy(file7)
ele1641 = rdnumpy(file8)
ele3161 = rdnumpy(file9)

vel41 = rdnumpy(file10)
vel1661 = rdnumpy(file11)
vel3281 = rdnumpy(file12)
#----------------------------- Right column file -----------------------------------
ele80 = rdnumpy(file13)
ele1680 = rdnumpy(file14)
ele3200 = rdnumpy(file15)

vel81 = rdnumpy(file16)
vel1701 = rdnumpy(file17)
vel3321 = rdnumpy(file18)
...
x_axis = 0.05
draw_stress("Left side stress",ele1,ele1601,ele3121,"ele1","ele1601","ele3121")
ax1 = plt.gca()
...
draw_stress("Center side stress",ele41,ele1641,ele3161,"ele41","ele1641","ele3161")
ax3 = plt.gca()
...
draw_stress("Right side stress",ele80,ele1680,ele3200,"ele80","ele1680","ele3200")
ax2 = plt.gca()
...
draw_Vel("Left side Velocity",vel1,vel1621,vel3241,"vel1","vel1621","vel3241")
ax4 = plt.gca()
...
draw_Vel("Center side Velocity",vel41,vel1661,vel3281,"vel41","vel1661","vel3281")
ax6 = plt.gca()
...
draw_Vel("Right side Velocity",vel81,vel1701,vel3321,"vel81","vel1701","vel3321")
ax5 = plt.gca()
