...
def DifferTime_RelativeError2(TiePErr, Type1PErr, Type2PErr, Type3PErr, TieSErr, Type1SErr, Type2SErr, Type3SErr):
    # ------------ P wave --------------------------
    plt.plot(Dy_lamb_Pwave[:], TiePErr[:,1],marker = '^',markersize=12,markerfacecolor = 'white',label = 'Tie', color = 'limegreen', linewidth = 3.0)
    # plt.plot(Dy_lamb_Pwave[:,0], LKErr[:,Peak],marker = 'o',markersize=10,markerfacecolor = 'white',label = 'LK Dashpot')
    plt.plot(Dy_lamb_Pwave[:], Type1PErr[:,1],marker = '<',markersize=8,markerfacecolor = 'white',label = 'Beam_Base', color = 'limegreen', ls = '--', linewidth = 3.0)
    plt.plot(Dy_lamb_Pwave[:], Type2PErr[:,1],marker = 's',markersize=6,markerfacecolor = 'white',label = 'Hybrid', color = 'limegreen', ls =':', linewidth = 3.0)
    plt.plot(Dy_lamb_Pwave[:], Type3PErr[:,1],marker = 'p',markersize=4,markerfacecolor = 'white',label = 'Node_Base', color = 'limegreen', ls = '-.', linewidth = 3.0)
    
 # ----------------S wave------------------------------
    plt.plot(Dy_lamb_Swave[:], TieSErr[:,1],marker = '^',markersize=12,markerfacecolor = 'white', color = 'orange', linewidth = 3.0)
    # plt.plot(Dy_lamb_Swave[:,0], LKErr[:,1],marker = 'o',markersize=10,markerfacecolor = 'white',label = 'LK Dashpot')
    plt.plot(Dy_lamb_Swave[:], Type1SErr[:,1],marker = '<',markersize=8,markerfacecolor = 'white', color = 'orange', ls = '--', linewidth = 3.0)
    plt.plot(Dy_lamb_Swave[:], Type2SErr[:,1],marker = 's',markersize=6,markerfacecolor = 'white', color = 'orange', ls =':', linewidth = 3.0)
    plt.plot(Dy_lamb_Swave[:], Type3SErr[:,1],marker = 'p',markersize=4,markerfacecolor = 'white', color = 'orange', ls = '-.', linewidth = 3.0)
...
fig1.text(0.41,0.89, "(Middle Node)", color = "red", fontsize=20)

fig1.text(0.02,0.5, 'Peak Velocity Error: '+ r"$\ E_{Max}$" + r" (%)", va= 'center', rotation= 'vertical', fontsize=20)
fig1.text(0.50,0.060, r'$\Delta_c/\lambda_p$', va= 'center', fontsize=20)
...
ax1.set_title(r"$w=$ $\mathrm{20m}$",fontsize =23, x=0.50, y=0.65)
...
ax2.set_title(r"$w=$ $\mathrm{10m}$",fontsize =23, x=0.50, y=0.65)
...
ax3.set_title(r"$w=$ $\mathrm{2m}$",fontsize =23, x=0.50, y=0.65)

font_props = {'family': 'Arial', 'size': 17}  #Legend Setting
legend_elements = [Line2D([0], [0], color='limegreen', lw=2, label= f'P wave'),
                Line2D([0], [0], color='orange', lw=2, label='S wave'),]

legend_elements2 =  [Line2D([0], [0], color='black',marker = '^',markersize=12,markerfacecolor = 'white', label= 'Tie'),
                    Line2D([0], [0], color='black',marker = 'o',markersize=11,markerfacecolor = 'white', label= 'Beam_Base'),
                    Line2D([0], [0], color='black',marker = '<',markersize=10,markerfacecolor = 'white', label= 'Hybrid'),
                    Line2D([0], [0], color='black',marker = 's',markersize=9,markerfacecolor = 'white', label= 'Node_Base')]

lines, labels = fig1.axes[-1].get_legend_handles_labels()
legend1 = fig1.legend(handles=legend_elements, loc=(0.77, 0.65) ,prop=font_props) # , title="Legend 1"
fig1.add_artist(legend1)

legend2 = fig1.legend(handles=legend_elements2, loc=(0.77, 0.85) ,prop=font_props)
...
Add_PErr(Tie2Err_PL2,LK2_Perror, LK_W2_HZ10_P, LK_W2_HZ20_P, LK_W2_HZ40_P, LK_W2_HZ80_P)
...
# fig2.text(0.41,0.89, "(Middle Node)", color = "red", fontsize=20)

# fig2.text(0.01,0.5, 'L2 normalization: '+ r"$\ E_{L2}$", va= 'center', rotation= 'vertical', fontsize=25)
# fig2.text(0.50,0.060, r'$\Delta_c/\lambda_p$', va= 'center', fontsize=20)
...
# ax4.set_title(r"$w=$ $\mathrm{20m}$",fontsize =23, x=0.50, y=0.65)
...
# ax5.set_title(r"$w=$ $\mathrm{10m}$",fontsize =23, x=0.50, y=0.65)
...
# ax6.set_title(r"$w=$ $\mathrm{2m}$",fontsize =23, x=0.50, y=0.65)
...
# legend1 = fig2.legend(handles=legend_elements, loc=(0.77, 0.65) ,prop=font_props) # , title="Legend 1"
# fig2.add_artist(legend1)

# legend2 = fig2.legend(handles=legend_elements2, loc=(0.77, 0.85) ,prop=font_props)
