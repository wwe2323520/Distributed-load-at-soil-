...
XNodeOut = np.zeros((len(total_Transport_cs),Nnode))
Endx0 = Nele*10
# X = 10m ~ 20m
for j in range(Nnode):# Nnode 101
    tNout = timecs_Node[10*j]
    x0 =  L-dy*j# x[Endx0-10*j]
    # print(x0,cs*tNout)
    for i in range(len(timecs_Node)):      
        xoo = x0 + dx*i 
...
# ----- Swave sigma_yy --------------------------   
        ...
        if total_time[t] >= 0.050 and total_time[t] < (0.050+Input_Time): # total_time[t] >= 0.025 and total_time[t] < 0.050
...
for m in range(Nnode): #Nnode 101/ 81
    ...
    for n in range(len(total_time)):
        if total_time[n] < Input_Time: # total_time[n] < 0.05
# ----- Swave eta_p*(Vx) -------------------------- 
...
# ----- Swave sigma_xy ---------------------------------------
        ...
        if total_time[n] >= 0.05 and total_time[n] < (0.05+Input_Time):  # total_time[n] >= 0.05 and total_time[n] < 0.1
# ----- Swave eta_p*(Vx) taux -------------------------- 
...
# plt.plot(total_Transport_cs, XNodeIn[:,0],label ='Node 1',marker='o', markevery=100)
# plt.plot(total_Transport_cs, XNodeIn[:, int(Nele/2)],label ='Node 40',marker='d', markevery=100) # XNodeIn[:,40]
# plt.plot(total_Transport_cs, XNodeIn[:, int(Nele)],label ='Node 81',marker='x', markevery=100) # XNodeIn[:,80]
...
# plt.xlabel("x(m)",fontsize=18)
# plt.ylabel(r"$y=sin\omega(x+c_{s}t)$",fontsize=18)
# plt.plot(total_Transport_cs, XNodeOut[:,0],label ='Node 1',marker='o', markevery=100)
# plt.plot(total_Transport_cs, XNodeOut[:, int(Nele/2)],label ='Node 40',marker='d', markevery=100)
# plt.plot(total_Transport_cs, XNodeOut[:, int(Nele)],label ='Node 80',marker='x', markevery=100)
# plt.xlim(0,2*L)
...
# plt.xlabel("x(m)",fontsize=18)
# plt.ylabel(r"$y=sin\omega(x-c_{s}t)$",fontsize=18)
# plt.plot(total_Transport_cs, XIn[:,0],label ='ele 1',marker='o', markevery=100) # XIn[:,0]
# plt.plot(total_Transport_cs, XIn[:, int(Nele/2)-1],label ='ele 39',marker='d', markevery=100) # XIn[:,39]
# plt.plot(total_Transport_cs, XIn[:, int(Nele-1)],label ='ele 79',marker='x', markevery=100) # XIn[:,79]
# plt.legend(loc='upper right',fontsize=18)
# plt.xlim(0,2*L)
# plt.xticks(fontsize = 15)
# plt.yticks(fontsize = 15)
...
# plt.xlabel("x(m)",fontsize=18)
# plt.ylabel(r"$y=sin\omega(x+c_{s}t)$",fontsize=18)
# plt.plot(total_Transport_cs, XOut[:,0],label ='ele 1',marker='o', markevery=100)
# plt.plot(total_Transport_cs, XOut[:,int(Nele/2)-1],label ='ele 39',marker='d', markevery=100)
# plt.plot(total_Transport_cs, XOut[:,int(Nele-1)],label ='ele 79',marker='x', markevery=100)
# plt.xlim(0, 2*L)
