...
# fig4.text(0.13,0.81, "Middle Node", color = "black", fontsize=23) # 0.65
# fig4.text(0.13,0.85, f'S wave '+ r"($t_d=0.0125$ $\mathrm {s}$)", color = "black", fontsize=22) # 0.50
...
# ax10.set_title(r"$w=$ $\mathrm{20m}$",fontsize =25, x=0.14, y=0.08) # x = 0.84
...
# ax11.set_title(r"$w=$ $\mathrm{10m}$",fontsize =25, x=0.14, y=0.08)
...
# ax12.set_title(r"$w=$ $\mathrm{2m}$",fontsize =25, x=0.14, y=0.08)
...
# row_heights = [3,3,3]
# fig1, (ax3, ax4) = plt.subplots(nrows= 2, ncols=1, sharex=True, figsize=(8, sum(row_heights)))
# # fig1.suptitle(f'Different Boundary Compare',x=0.50,y =0.95,fontsize = 20)
# fig1.text(0.65,0.81, "Middle Node", color = "black", fontsize=23)
# fig1.text(0.58,0.85, f'S wave '+ r"($w=2$ $\mathrm {m}$)", color = "black", fontsize=22)
# fig1.text(0.02,0.5, r"$\mathrm {Velocity}$  $v_x$  $\mathrm {(m/s)}$", va= 'center', rotation= 'vertical', fontsize=22)
# fig1.text(0.42,0.05, r"$\mathrm {time}$ ${t}$ $(s)$", va= 'center', fontsize=22) # $(10^{-1}\,s)$
...
# ax3 = plt.subplot(211) # 413
# Differ_BCVel(total_time_HZ40, HZ40_Swave, Tie_W2_HZ40_Mid, LK_W2_HZ40_Mid, Type1_W2_HZ40_Mid, Type2_W2_HZ40_Mid, Type3_W2_HZ40_Mid)
# ax3.set_title(r"$t_d=0.025$ $\mathrm {s}$",fontsize =22, x=0.84, y=0.08)

# ax4 = plt.subplot(212) # 414
# Differ_BCVel(total_time_HZ80, HZ80_Swave, Tie_W2_HZ80_Mid, LK_W2_HZ80_Mid, Type1_W2_HZ80_Mid, Type2_W2_HZ80_Mid, Type3_W2_HZ80_Mid)
# ax4.set_title(r"$t_d=0.0125$ $\mathrm {s}$",fontsize =22, x=0.84, y=0.08)

# font_props = {'family': 'Arial', 'size': 15}  #Legend Setting

# lines, labels = fig1.axes[-1].get_legend_handles_labels()
# fig1.legend(lines, labels, ncol=3, loc = (0.35, 0.89), prop=font_props)
