...
Y_MeshNumber= np.array([80]) # 80, 40, 20, 10
...
for i in range(len(Width)):
    ...
    for j in range(len(Force_HZ)):
        ...
        for h in range(len(Y_MeshNumber)):
            ...
            # ================= Build Boundary File =====================
            Boundary = f"{Choose_Wave}/W_{int(soilwidth)}m_Dc80row/HZ_{HZ}/TieBC_{ny}row" # {Choose_Wave}/W_{int(soilwidth)}m/HZ_{HZ}/BeamType3_{ny}row / {Choose_Wave}/Dt_{Dt_Size}/HZ_{HZ}/row{ny}
