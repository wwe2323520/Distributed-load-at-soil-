...
# ================= Build Boundary File =====================
Boundary = f"{Choose_Wave}/W_{int(soilwidth)}m/HZ_{HZ}/BeamSide_{ny}row"
...
# ============================== S wave ======================================
SideBeam_TimePath = f'D:/shiang/opensees/20220330/OpenSeesPy/TimeSeries/Swave_Time/SideBeam_Time'
Cs_dt =  (yMesh/Vs)*0.1
Cp_dt =  (yMesh/Vp)*0.1
...
pattern('Plain',703, 707) # TimeSeries_Num
# load(95,0,-1)
# # ------------- P wave -----------------------------
# for o in range(nx):
