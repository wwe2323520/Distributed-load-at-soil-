...
Condition1 = f'1D_Transport/Pwave/W_2m/HZ_{HZ}'
...
# --------- Tie Boundary Condition ----------------
Condition2 = f'1D_Transport/Pwave/W_10m/HZ_{HZ}'
...
# --------- Tie Boundary Condition ----------------
Condition3 = f'1D_Transport/Pwave/W_20m/HZ_{HZ}'
...
def Differ_BCVel(total_time, Pwave, Tie, LKDash, BeamType1, BeamType2, BeamType3):
    ...
    plt.plot(total_time, Pwave[:,79],label =r'$\mathrm{Analytical}$',color= 'black',linewidth=6.0)
...
fig1.text(0.55,0.80, r"$\mathrm {Pwave}$ $(t_{d} = 1/40)$", color = "blue", fontsize=22)
...
ax1 = plt.subplot(311)
Differ_BCVel(total_time,Pwave, Tie_W20_Mid80row, LK_W20_Mid80row, Tyep1_W20_Mid80row, Tyep2_W20_Mid80row, Tyep3_W20_Mid80row)
ax1.set_title(r"$w=$ $\mathrm{20m}$",fontsize =23, x=0.50, y=0.78)

ax2 = plt.subplot(312)
Differ_BCVel(total_time,Pwave, Tie_W10_Mid80row, LK_W10_Mid80row, Tyep1_W10_Mid80row, Tyep2_W10_Mid80row, Tyep3_W10_Mid80row)
ax2.set_title(r"$w=$ $\mathrm{10m}$",fontsize =23, x=0.50, y=0.78)

ax3 = plt.subplot(313)
Differ_BCVel(total_time,Pwave, Tie_W2_Mid80row, LK_W2_Mid80row, Tyep1_W2_Mid80row, Tyep2_W2_Mid80row, Tyep3_W2_Mid80row)
...
# fig2.text(0.55,0.80, r"$\mathrm {Pwave}$ $(t_{d} = 1/40)$", color = "blue", fontsize=22)
...
# fig3.text(0.55,0.80, r"$\mathrm {Pwave}$ $(t_{d} = 1/40)$", color = "blue", fontsize=22)
...
# ax7 = plt.subplot(311)
# Differ_BCVel(total_time,Pwave, Tie_W20_Mid20row, LK_W20_Mid20row, Tyep1_W20_Mid20row, Tyep2_W20_Mid20row, Tyep3_W20_Mid20row)
# ax7.set_title(r"$w=$ $\mathrm{20m}$",fontsize =23, x=0.50, y=0.78)

# ax8 = plt.subplot(312)
# Differ_BCVel(total_time,Pwave, Tie_W10_Mid20row, LK_W10_Mid20row, Tyep1_W10_Mid20row, Tyep2_W10_Mid20row, Tyep3_W10_Mid20row)
# ax8.set_title(r"$w=$ $\mathrm{10m}$",fontsize =23, x=0.50, y=0.78)

# ax9 = plt.subplot(313)
# Differ_BCVel(total_time,Pwave, Tie_W2_Mid20row, LK_W2_Mid20row, Tyep1_W2_Mid20row, Tyep2_W2_Mid20row, Tyep3_W2_Mid20row)
...
# fig4.text(0.55,0.80, r"$\mathrm {Pwave}$ $(t_{d} = 1/40)$", color = "blue", fontsize=22)
...
# Differ_BCVel(total_time,Pwave, Tie_W20_Mid10row, LK_W20_Mid10row, Tyep1_W20_Mid10row, Tyep2_W20_Mid10row, Tyep3_W20_Mid10row)
# ax10.set_title(r"$w=$ $\mathrm{20m}$",fontsize =23, x=0.50, y=0.78)

# ax11 = plt.subplot(312)
# Differ_BCVel(total_time,Pwave, Tie_W10_Mid10row, LK_W10_Mid10row, Tyep1_W10_Mid10row, Tyep2_W10_Mid10row, Tyep3_W10_Mid10row)
# ax11.set_title(r"$w=$ $\mathrm{10m}$",fontsize =23, x=0.50, y=0.78)

# ax12 = plt.subplot(313)
# Differ_BCVel(total_time,Pwave, Tie_W2_Mid10row, LK_W2_Mid10row, Tyep1_W2_Mid10row, Tyep2_W2_Mid10row, Tyep3_W2_Mid10row)
...
lines, labels = fig5.axes[-1].get_legend_handles_labels()
fig5.legend(lines, labels, loc = (0.77,0.65) ,prop=font_props)
...
# fig6.text(0.5,0.85, r"$\mathrm {Pwave}$ $(t_{d} = 1/40)$", color = "blue", fontsize=22)
...
# ax16.set_title(r"$w=$ $\mathrm{20m}$",fontsize =23, x=0.15, y=0.80)
...
# lines, labels = fig6.axes[-1].get_legend_handles_labels()
# fig6.legend(lines, labels, loc = (0.77,0.62),prop=font_props)
