...
for g in range(Nele): #Nele
    ...
    for t in range(len(total_time)):
        if total_time[t] < Input_Time: # total_time[t] < 0.025 / Input_Time
...
# plt.plot(total_Transport_cp, XNodeIn[:,0],label ='Node 1',marker='o', markevery=100)
# plt.plot(total_Transport_cp, XNodeIn[:, int(Nele/2)],label ='Node 40',marker='d', markevery=100) # XNodeIn[:,40]
# plt.plot(total_Transport_cp, XNodeIn[:, int(Nele)],label ='Node 81',marker='x', markevery=100) # XNodeIn[:,80]
...
# plt.xlabel("x(m)",fontsize=18)
# plt.ylabel(r"$y=sin\omega(x+c_{s}t)$",fontsize=18)
# plt.plot(total_Transport_cp, XNodeOut[:,0],label ='Node 1',marker='o', markevery=100)
# plt.plot(total_Transport_cp, XNodeOut[:, int(Nele/2)],label ='Node 40',marker='d', markevery=100)
# plt.plot(total_Transport_cp, XNodeOut[:, int(Nele)],label ='Node 80',marker='x', markevery=100)
# plt.xlim(0,2*L)
...
# # ========== Incoming Wave ==========================================
# plt.figure()
# plt.title('Incoming Wave ' + r"f = 20Hz",fontsize = 18)
# plt.xlabel("x(m)",fontsize=18)
# plt.ylabel(r"$y=sin\omega(x-c_{p}t)$",fontsize=18)
...
# # ========== Outcoming Wave ==========================================
# plt.figure()
# plt.title('Outcoming Wave'+ r"f = 20Hz",fontsize = 18)
# plt.xlabel("x(m)",fontsize=18)
# plt.ylabel(r"$y=sin\omega(x+c_{p}t)$",fontsize=18)
