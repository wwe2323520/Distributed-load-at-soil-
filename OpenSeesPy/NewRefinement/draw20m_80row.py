...
file2 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele6401.out"
file3 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele12641.out"
...
file8 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele6481.out"
file9 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele12721.out"
...
file14 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele6560.out"
file15 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele12800.out"
...
#----------------------------- Left column file -----------------------------------
ele1 = rdnumpy(file1)
ele6401 = rdnumpy(file2)
ele12641 = rdnumpy(file3)

vel1 = rdnumpy(file4)
vel6441 = rdnumpy(file5)
vel12881 = rdnumpy(file6)
#----------------------------- Center column file -----------------------------------
ele81 = rdnumpy(file7)
ele6481 = rdnumpy(file8)
ele12721 = rdnumpy(file9)

vel81 = rdnumpy(file10)
vel6521 = rdnumpy(file11)
vel12961 = rdnumpy(file12)
#----------------------------- Right column file -----------------------------------
ele160 = rdnumpy(file13)
ele6560 = rdnumpy(file14)
ele12800 = rdnumpy(file15)

vel161 = rdnumpy(file16)
vel6601 = rdnumpy(file17)
vel13041 = rdnumpy(file18)
...
x_axis = 0.05
draw_stress("Left side stress",ele1,ele6401,ele12641,"ele1","ele6401","ele12641")
ax1 = plt.gca()
...
draw_stress("Center side stress",ele81,ele6481,ele12721,"ele81","ele6481","ele12721")
ax3 = plt.gca()
...
draw_stress("Right side stress",ele160,ele6560,ele12800,"ele160","ele6560","ele12800")
ax2 = plt.gca()
...
draw_Vel("Left side Velocity",vel1,vel6441,vel12881,"vel1","vel6441","vel12881")
ax4 = plt.gca()
...
draw_Vel("Center side Velocity",vel81,vel6521,vel12961,"vel81","vel6521","vel12961")
ax6 = plt.gca()
...
draw_Vel("Right side Velocity",vel161,vel6601,vel13041,"vel161","vel6601","vel13041")
ax5 = plt.gca()
