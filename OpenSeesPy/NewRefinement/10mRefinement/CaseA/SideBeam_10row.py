...
# ==================== Side Beam node (1385~1395 / 1396~1406) ====================
for i in range(ny+1):
# ----- Left Side: 1385~1395 -----------------
    node(1385+i, 0.0, yMesh*i)
    fix(1385+i,0,0,1)
# ----- Right Side: 1396~1406 -----------------
    node(1396+i,10.0,yMesh*i)
    fix(1396+i,0,0,1)

# ------------  Beam Element: 1087 ~ 1096 / 1097 ~ 1106 ------------------
for j in range(ny):
# ----- Left Side Beam:1087 ~ 1096 -----------------
    element('elasticBeamColumn', 1087+j, 1385+j, 1386+j, A,E1,Iz, 1, '-release', 3)
# ----- Right Side Beam:1097 ~ 1106 -----------------
    element('elasticBeamColumn', 1097+j, 1396+j, 1397+j, A,E1,Iz, 1, '-release', 3)

# --------- Side Beam and Soil BC -----------------
for j in range(ny+1):
    equalDOF(1+81*j,1385+j,1,2)
    equalDOF(81+81*j,1396+j,1,2)
...
# ---------- Distributed at Left Side Beam ----------------------
    eleLoad('-ele',1087+g, '-type', '-beamUniform',-20,0)  # for local axes Wy -
# ---------- Distributed at Right Side Beam ----------------------
    eleLoad('-ele',1097+g, '-type', '-beamUniform',-20,0)   # for local axes Wy +
...
# ---------- Distributed at Left Side Beam ----------------------
    eleLoad('-ele',1087+g, '-type', '-beamUniform',0,+20,0)  # for local axes Wx +
# ---------- Distributed at Right Side Beam ----------------------
    eleLoad('-ele',1097+g, '-type', '-beamUniform',0,-20,0)   # for local axes Wx -
