...
file2 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele71.out"
file3 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele134.out"
...
file8 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele74.out"
file9 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele137.out"
...
file14 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele77.out"
file15 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele140.out"
...
ele1 = rdnumpy(file1)
ele71 = rdnumpy(file2)
ele134 = rdnumpy(file3)

vel1 = rdnumpy(file4)
vel81 = rdnumpy(file5)
vel161 = rdnumpy(file6)

#----------------------------- Center column file -----------------------------------
ele4 = rdnumpy(file7)
ele74 = rdnumpy(file8)
ele137 = rdnumpy(file9)

vel4 = rdnumpy(file10)
vel84 = rdnumpy(file11)
vel164 = rdnumpy(file12)

#----------------------------- Right column file -----------------------------------
ele7 = rdnumpy(file13)
ele77 = rdnumpy(file14)
ele140 = rdnumpy(file15)

vel8 = rdnumpy(file16)
vel88 = rdnumpy(file17)
vel168 = rdnumpy(file18)
...
x_axis = 0.05
draw_stress("Left side stress",ele1,ele71,ele134,"ele1","ele71","ele134")
ax1 = plt.gca()
...
draw_stress("Center side stress",ele4,ele74,ele137,"ele4","ele74","ele137")
ax3 = plt.gca()
...
draw_stress("Right side stress",ele7,ele77,ele140,"ele7","ele77","ele140")
ax2 = plt.gca()
...
draw_Vel("Left side Velocity",vel1,vel81,vel161,"vel1","vel81","vel161")
ax4 = plt.gca()
...
draw_Vel("Center side Velocity",vel4,vel84,vel164,"vel4","vel84","vel164")
ax6 = plt.gca()
...
draw_Vel("Right side Velocity",vel8,vel88,vel168,"vel8","vel88","vel168")
ax5 = plt.gca()
