...
file2 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele561.out"
file3 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele1114.out"
...
file8 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele564.out"
file9 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele1117.out"
...
file14 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele567.out"
file15 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele1120.out"
...
#----------------------------- Left column file -----------------------------------
ele1 = rdnumpy(file1)
ele561 = rdnumpy(file2)
ele1114 = rdnumpy(file3)

vel1 = rdnumpy(file4)
vel641 = rdnumpy(file5)
vel1281 = rdnumpy(file6)

#----------------------------- Center column file -----------------------------------
ele4 = rdnumpy(file7)
ele564 = rdnumpy(file8)
ele1117 = rdnumpy(file9)

vel4 = rdnumpy(file10)
vel644 = rdnumpy(file11)
vel1284 = rdnumpy(file12)

#----------------------------- Right column file -----------------------------------
ele7 = rdnumpy(file13)
ele567 = rdnumpy(file14)
ele1120 = rdnumpy(file15)

vel8 = rdnumpy(file16)
vel648 = rdnumpy(file17)
vel1288 = rdnumpy(file18)
...
x_axis = 0.05
draw_stress("Left side stress",ele1,ele561,ele1114,"ele1","ele561","ele1114")
ax1 = plt.gca()
...
draw_stress("Center side stress",ele4,ele564,ele1117,"ele4","ele564","ele1117")
ax3 = plt.gca()
...
draw_stress("Right side stress",ele7,ele567,ele1120,"ele7","ele567","ele1120")
ax2 = plt.gca()
...
draw_Vel("Left side Velocity",vel1,vel641,vel1281,"vel1","vel641","vel1281")
ax4 = plt.gca()
...
draw_Vel("Center side Velocity",vel4,vel644,vel1284,"vel4","vel644","vel1284")
ax6 = plt.gca()
...
draw_Vel("Right side Velocity",vel8,vel648,vel1288,"vel8","vel648","vel1288")
ax5 = plt.gca()
