...
file2 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele281.out"
file3 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele554.out"
...
file8 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele284.out"
file9 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele557.out"
...
file14 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele287.out"
file15 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele560.out"
...
#----------------------------- Left column file -----------------------------------
ele1 = rdnumpy(file1)
ele281 = rdnumpy(file2)
ele554 = rdnumpy(file3)

vel1 = rdnumpy(file4)
vel321 = rdnumpy(file5)
vel641 = rdnumpy(file6)

#----------------------------- Center column file -----------------------------------
ele4 = rdnumpy(file7)
ele284 = rdnumpy(file8)
ele557 = rdnumpy(file9)

vel4 = rdnumpy(file10)
vel324 = rdnumpy(file11)
vel644 = rdnumpy(file12)

#----------------------------- Right column file -----------------------------------
ele7 = rdnumpy(file13)
ele287 = rdnumpy(file14)
ele560 = rdnumpy(file15)

vel8 = rdnumpy(file16)
vel328 = rdnumpy(file17)
vel648 = rdnumpy(file18)
...
x_axis = 0.05
draw_stress("Left side stress",ele1,ele281,ele554,"ele1","ele281","ele554")
ax1 = plt.gca()
...
draw_stress("Center side stress",ele4,ele284,ele557,"ele4","ele284","ele557")
ax3 = plt.gca()
...
draw_stress("Right side stress",ele7,ele287,ele560,"ele7","ele287","ele560")
ax2 = plt.gca()
...
draw_Vel("Left side Velocity",vel1,vel321,vel641,"vel1","vel321","vel641")
ax4 = plt.gca()
...
draw_Vel("Center side Velocity",vel4,vel324,vel644,"vel4","vel324","vel644")
ax6 = plt.gca()
...
draw_Vel("Right side Velocity",vel8,vel328,vel648,"vel8","vel328","vel648")
ax5 = plt.gca()
