...
file2 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele36.out"
file3 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele64.out"
...
file8 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele39.out"
file9 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele67.out"
...
file14 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele42.out"
file15 = r"D:\shiang\opensees\20220330\OpenSeesPy\Stress\ele70.out"
...
vel4 = rdnumpy(file10)
vel44 = rdnumpy(file11)
vel84 = rdnumpy(file12)

#----------------------------- Right column file -----------------------------------
ele7 = rdnumpy(file13)
ele42 = rdnumpy(file14)
ele70 = rdnumpy(file15)

vel8 = rdnumpy(file16)
vel48 = rdnumpy(file17)
vel88 = rdnumpy(file18)
...
x_axis = 0.05
draw_stress("Left side stress",ele1,ele36,ele64,"ele1","ele36","ele64")
ax1 = plt.gca()
...
draw_stress("Center side stress",ele4,ele39,ele67,"ele4","ele39","ele67")
ax3 = plt.gca()
...
draw_stress("Right side stress",ele7,ele42,ele70,"ele7","ele42","ele70")
ax2 = plt.gca()
...
draw_Vel("Left side Velocity",vel1,vel41,vel81,"vel1","vel41","vel81")
ax4 = plt.gca()
...
draw_Vel("Center side Velocity",vel4,vel44,vel84,"vel4","vel44","vel84")
ax6 = plt.gca()
...
draw_Vel("Right side Velocity",vel8,vel48,vel88,"vel8","vel48","vel88")
ax5 = plt.gca()
