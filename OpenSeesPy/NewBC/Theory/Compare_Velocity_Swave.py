...
# file1 = r"D:\shiang\opensees\20220330\OpenSeesPy\Velocity\0.7m\Bot_Pwave\node804.out"
...
# # -----Wave Velocity Transport  -------------
# plt.plot(total_time,Swave[:,0],label ='Element 1', marker='o', markevery=100)
# plt.plot(total_time,Swave[:,50],label ='Element 51', marker='x', markevery=100)
plt.plot(total_time,Swave[:,99],label ='Theory', marker='d', markevery=100,color= 'Black')

# plt.plot(vel804[:,0],vel804[:,plt_axis2],label ='(1/2)velocity 804', marker='o', markevery=100)
# plt.plot(vel806[:,0],vel806[:,plt_axis2],label ='(1/4)velocity 806', marker='x', markevery=100)
