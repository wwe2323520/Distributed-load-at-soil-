...
#     timeSeries('Path',800+g, '-filePath',f'P_Sideforce_Inx/ele{1+g}.txt','-dt',1e-4)
...
# for g in range(100):
# # ------- timeSeries ID: 800~899 (global x force) ----------------------
#     timeSeries('Path',900+g, '-filePath',f'P_Sideforce_Outx/ele{1+g}.txt','-dt',1e-4)
...
#     timeSeries('Path',1000+g, '-filePath',f'P_Sideforce_Iny/ele{1+g}.txt','-dt',1e-4)
...
# # ------- timeSeries ID: 900~999 (global y force)----------------------
# # ---------- y direction : Sideforce --------------------
#     timeSeries('Path',1100+g, '-filePath',f'P_Sideforce_Outy/ele{1+g}.txt','-dt',1e-4)
#     pattern('Plain',1104+g, 1100+g)
# # ---------- For P wave : y direction ---------------------
# # ---------- Distributed at Left Side Beam ----------------------
#     eleLoad('-ele',1221+g, '-type', '-beamUniform',0,20,0)  # for local axes Wx
# # ---------- Distributed at Right Side Beam ----------------------
...
# ------- timeSeries ID: 800~899 ----------------------
    timeSeries('Path',800+g, '-filePath',f'S_Sideforce_Inx/ele{1+g}.txt','-dt',1e-4)
    pattern('Plain',804+g, 800+g)
# ---------- x direction : Sideforce ---------------------
# ---------- Distributed at Left Side Beam ----------------------
    eleLoad('-ele',1221+g, '-type', '-beamUniform',-20,0)  # for local axes Wy -
...
for g in range(100):
# ------- timeSeries ID: 800~899 ----------------------
    timeSeries('Path',900+g, '-filePath',f'S_Sideforce_Outx/ele{1+g}.txt','-dt',1e-4)
    pattern('Plain',904+g, 900+g)
# ---------- x direction : Sideforce ---------------------
# ---------- Distributed at Left Side Beam ----------------------
    eleLoad('-ele',1221+g, '-type', '-beamUniform',-20,0)  # for local axes Wy -
...
# ---------- y direction : Sideforce --------------------
    timeSeries('Path',1000+g, '-filePath',f'S_Sideforce_Iny/ele{1+g}.txt','-dt',1e-4)
    pattern('Plain',1004+g, 1000+g)
# ---------- For P wave : y direction ---------------------
# ---------- Distributed at Left Side Beam ----------------------
    eleLoad('-ele',1221+g, '-type', '-beamUniform',0,+20,0)  # for local axes Wx +
...
# ------- timeSeries ID: 900~999 ----------------------
# ---------- y direction : Sideforce --------------------
    timeSeries('Path',1100+g, '-filePath',f'S_Sideforce_Outy/ele{1+g}.txt','-dt',1e-4)
    pattern('Plain',1104+g, 1100+g)
# ---------- For P wave : y direction ---------------------
# ---------- Distributed at Left Side Beam -----------------------
    eleLoad('-ele',1221+g, '-type', '-beamUniform',0,+20,0)  # for local axes Wx +
