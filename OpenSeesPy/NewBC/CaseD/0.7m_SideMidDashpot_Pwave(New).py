...
sizeBeam = 0.05*1.0
S_Smp = 1.0*rho*Vp*sizeBeam    # side Normal dashpot for S wave   ; lower/Upper  Left and Right corner node 0.5
S_Sms = 1.0*rho*Vs*sizeBeam    # side Traction dashpot for P wave ; lower/Upper Left and Right corner node 0.5

S_Cmp = 1.0*rho*Vp*sizeBeam    # side Normal dashpot for S wave: Netwon
S_Cms = 1.0*rho*Vs*sizeBeam    # side Traction dashpot for P wave: Netwon
...
#---- Left ------
recorder('Node', '-file', 'Velocity/node850.out', '-time', '-node',850,'-dof',1,2,3,'vel')
recorder('Node', '-file', 'Velocity/node950.out', '-time', '-node',950,'-dof',1,2,3,'vel')
recorder('Node', '-file', 'Velocity/node1050.out', '-time', '-node',1050,'-dof',1,2,3,'vel')
...
#---- Right ------
recorder('Node', '-file', 'Velocity/node1051.out', '-time', '-node',1051,'-dof',1,2,3,'vel')
recorder('Node', '-file', 'Velocity/node1151.out', '-time', '-node',1151,'-dof',1,2,3,'vel')
recorder('Node', '-file', 'Velocity/node1251.out', '-time', '-node',1251,'-dof',1,2,3,'vel')

recorder('Node', '-file', 'Velocity/node1052.out', '-time', '-node',1052,'-dof',1,2,3,'vel')
recorder('Node', '-file', 'Velocity/node1152.out', '-time', '-node',1152,'-dof',1,2,3,'vel')
