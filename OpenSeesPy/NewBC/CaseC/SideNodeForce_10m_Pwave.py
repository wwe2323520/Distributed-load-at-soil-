...
# ==================== Side Beam node (11515~11615 / 11616~11716) ====================
for i in range(ny+1):
...
# ----- Left Side Beam:20606 ~ 20705 -----------------
    element('elasticBeamColumn', 20606+j, 11515+j, 11516+j, A,E1,Iz, 1, '-release', 3)
# ----- Right Side Beam:20706 ~ 20805 -----------------
    element('elasticBeamColumn', 20706+j, 11616+j, 11617+j, A,E1,Iz, 1, '-release', 3)
...
timeSeries('Path',900, '-filePath',f'P_Nodeforce_y/Node{1}.txt','-dt',1e-4)
...
timeSeries('Path',1000, '-filePath',f'P_Nodeforce_y/Node{101}.txt','-dt',1e-4)
...
# filename = 'soil10m_SideFoece_Swave'
