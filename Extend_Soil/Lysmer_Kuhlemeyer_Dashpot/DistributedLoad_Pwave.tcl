...
# element zeroLength 5000 614 613 -mat 4000 -dir 1
# element zeroLength 5001 616 615 -mat 4000 -dir 1
# element zeroLength 5002 618 617 -mat 4000 -dir 1
# element zeroLength 5003 620 619 -mat 4000 -dir 1
# element zeroLength 5004 622 621 -mat 4000 -dir 1
# element zeroLength 5005 624 623 -mat 4000 -dir 1

element zeroLength 5000 614 613 -mat 4000 -dir 2
element zeroLength 5001 616 615 -mat 4000 -dir 2
element zeroLength 5002 618 617 -mat 4000 -dir 2
element zeroLength 5003 620 619 -mat 4000 -dir 2
element zeroLength 5004 622 621 -mat 4000 -dir 2
element zeroLength 5005 624 623 -mat 4000 -dir 2
...
#-------------  S wave -------------------------
    ...
    # load 611 $p 0 0
    # load 612 $p 0 0
    # eleLoad -ele 505 -type -beamUniform 0 [expr (20.0/5.0)] 0
    # eleLoad -ele 506 -type -beamUniform 0 [expr (20.0/5.0)] 0
    # eleLoad -ele 507 -type -beamUniform 0 [expr (20.0/5.0)] 0
    # eleLoad -ele 508 -type -beamUniform 0 [expr (20.0/5.0)] 0
    # eleLoad -ele 509 -type -beamUniform 0 [expr (20.0/5.0)] 0
...
#-------------  P wave ------------------------- 
    ...
    # load 611 0 $p 0
    # load 612 0 $p 0
    eleLoad -ele 505 -type -beamUniform [expr (20.0/5.0)] 0
    eleLoad -ele 506 -type -beamUniform [expr (20.0/5.0)] 0
    eleLoad -ele 507 -type -beamUniform [expr (20.0/5.0)] 0
    eleLoad -ele 508 -type -beamUniform [expr (20.0/5.0)] 0
    eleLoad -ele 509 -type -beamUniform [expr (20.0/5.0)] 0
}
...
# recorder mpco "extend_soil/MPCO/Swave_block2D" -E material.stress force localforce -N velocity displacement ;#
