...
element elasticBeamColumn 510 1030 1031  $A  $E1 $Iz 1 ;# 
#------------ Make Beam elements only Right and Left node have same disp --------------- 
equalDOF 1030 1031 1 2
#---------- Bottom Beam and Soil connect ------------------------
equalDOF 1030 603 1 2
equalDOF 1031 604 1 2

set filePath2 top_force.txt
timeSeries Path 704 -dt 0.0001 -filePath $filePath2;
pattern Plain 705 704 {
    # load 1030 0 -1
    # load 1031 0 -1
    eleLoad -ele 510 -type -beamUniform -20 0
}
