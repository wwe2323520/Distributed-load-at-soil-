...
# ------------- left side (1030,1031 ~ 1230,1231) 1130 1131 -------------------------------
#     node [expr 1030+2*$r] 0.0 [expr 0.1*$r]
#     node [expr 1031+2*$r] 0.0 [expr 0.1*$r]

#     fix [expr 1030+2*$r] 0 1 1  ;# x dir dashpot　
#     fix [expr 1031+2*$r] 1 1 1
# # ------------- right side (1232,1233 ~ 1432,1433)1332,1333 -------------------------------
#     node [expr 1232+2*$r] 0.0 [expr 0.1*$r]
#     node [expr 1233+2*$r] 0.0 [expr 0.1*$r]

#     fix [expr 1232+2*$r] 0 1 1  ;# x dir dashpot　
#     fix [expr 1233+2*$r] 1 1 1
}
...
#     equalDOF [expr 6*$r+6] [expr 1232+2*$r] 1
}
...
uniaxialMaterial Viscous 4001 $ms 1   ;# S wave
...
# # -------------- left dashpot (ele 5303~5403)--S wave(ms) -----------------
#     element zeroLength [expr 5303+$q] [expr 1233+2*$q] [expr 1232+2*$q] -mat 4001 -dir 1
}
...
#---------- Node Coordinates----------------
node 1030 0.2 10.0          ;# 0.2 9.9 (bottom surface)
node 1031 0.3 10.0          ;# 0.4 9.9
node 1032 0.2 10.2          ;# 0.2 10.1
node 1033 0.3 10.2          ;# 0.4 10.1
...
element elasticBeamColumn 611 1030 1032 $ACol $Ec $IzCol  $ColTransfTag      ;# Column 1
element elasticBeamColumn 612 1031 1033 $ACol $Ec $IzCol  $ColTransfTag      ;# Column 2
element elasticBeamColumn 613 1032 1033 $ABeam $Ec $IzBeam  $BeamTransfTag   ;# Beam 3
...
# element zeroLength 5405 614 613 -mat 4001 -dir 1
# element zeroLength 5406 616 615 -mat 4001 -dir 1
# element zeroLength 5407 618 617 -mat 4001 -dir 1
# element zeroLength 5408 620 619 -mat 4001 -dir 1
# element zeroLength 5409 622 621 -mat 4001 -dir 1
# element zeroLength 5410 624 623 -mat 4001 -dir 1

element zeroLength 5405 614 613 -mat 4000 -dir 2
element zeroLength 5406 616 615 -mat 4000 -dir 2
element zeroLength 5407 618 617 -mat 4000 -dir 2
element zeroLength 5408 620 619 -mat 4000 -dir 2
element zeroLength 5409 622 621 -mat 4000 -dir 2
element zeroLength 5410 624 623 -mat 4000 -dir 2
...
# ============ Input stress to modify structure reflect force (from the top) ====================
