...
set filePath fp2.txt   ;# fp2.txt/ fs.txt
...
recorder Element -file "Stress/10msoil/ele1_stress_P.out" -time -ele 1 material 1 stress
recorder Element -file "Stress/10msoil/ele5001_stress_P.out" -time -ele 5001 material 1 stress
recorder Element -file "Stress/10msoil/ele9901_stress_P.out" -time -ele 9901 material 1 stress

recorder Node -file "Velocity/10msoil/node1_vel_P.out" -time -node 1 -dof 1 2 3 vel;
recorder Node -file "Velocity/10msoil/node5051_vel_P.out" -time -node 5051 -dof 1 2 3 vel;
recorder Node -file "Velocity/10msoil/node10101_vel_P.out" -time -node 10101 -dof 1 2 3 vel;

#---------- Right B.C (ele 100,5100,10000 / node 101,5151 10201)-----------------------
recorder Element -file "Stress/10msoil/ele100_stress_P.out" -time -ele 100 material 1 stress
recorder Element -file "Stress/10msoil/ele5100_stress_P.out" -time -ele 5100 material 1 stress
recorder Element -file "Stress/10msoil/ele10000_stress_P.out" -time -ele 10000 material 1 stress

recorder Node -file "Velocity/10msoil/node101_vel_P.out" -time -node 101 -dof 1 2 3 vel;
recorder Node -file "Velocity/10msoil/node5151_vel_P.out" -time -node 5151 -dof 1 2 3 vel;
recorder Node -file "Velocity/10msoil/node10201_vel_P.out" -time -node 10201 -dof 1 2 3 vel;

#---------- Center Element/Node (ele 51,5051,9951 / node 51,5101,10151) -----------------------
recorder Element -file "Stress/10msoil/ele51_stress_P.out" -time -ele 51 material 1 stress
recorder Element -file "Stress/10msoil/ele5051_stress_P.out" -time -ele 5051 material 1 stress
recorder Element -file "Stress/10msoil/ele9951_stress_P.out" -time -ele 9951 material 1 stress

recorder Node -file "Velocity/10msoil/node51_vel_P.out" -time -node 51 -dof 1 2 3 vel;
recorder Node -file "Velocity/10msoil/node5101_vel_P.out" -time -node 5101 -dof 1 2 3 vel;
recorder Node -file "Velocity/10msoil/node10151_vel_P.out" -time -node 10151 -dof 1 2 3 vel;
