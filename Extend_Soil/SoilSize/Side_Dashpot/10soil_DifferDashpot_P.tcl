...
# ------------dIFFERENT RIGHT AND LEFT NODE :different dashpot
# ------ Left Traction --------
element zeroLength 20202 10708 10707 -mat 5000 -dir 2  ;# 0.5*rho*Vs : P wave
element zeroLength 20302 10908 10907 -mat 5000 -dir 2  ;# 0.5*rho*Vs : P wave
# ------ Left Normal --------
element zeroLength 20303 10910 10909 -mat 5001 -dir 1  ;# 0.5*rho*Vp: S wave
element zeroLength 20403 11110 11109 -mat 5001 -dir 1  ;# 0.5*rho*Vp: S wave

# ------ Right Traction --------
element zeroLength 20404 11112 11111 -mat 5000 -dir 2  ;# 0.5*rho*Vs : P wave
element zeroLength 20504 11312 11311 -mat 5000 -dir 2  ;# 0.5*rho*Vs : P wave
# ------ Right Normal --------
element zeroLength 20505 11314 11313 -mat 5001 -dir 1  ;# 0.5*rho*Vp: S wave
element zeroLength 20605 11514 11513 -mat 5001 -dir 1  ;# 0.5*rho*Vp: S wave



for {set f 1} {$f < $nx} {incr f} {
# -------------- Left side ------------------------
# -------------- traction dashpot element(ele 20203~20301) -----------------------
...
set filePath fp2.txt   ;# fp.txt/ fs.txt
...
recorder Element -file "Stress/10msoil/ele1_stress_Side_P.out" -time -ele 1 material 1 stress
recorder Element -file "Stress/10msoil/ele5001_stress_Side_P.out" -time -ele 5001 material 1 stress
recorder Element -file "Stress/10msoil/ele9901_stress_Side_P.out" -time -ele 9901 material 1 stress

recorder Node -file "Velocity/10msoil/node1_vel_Side_P.out" -time -node 1 -dof 1 2 3 vel;
recorder Node -file "Velocity/10msoil/node5051_vel_Side_P.out" -time -node 5051 -dof 1 2 3 vel;
recorder Node -file "Velocity/10msoil/node10101_vel_Side_P.out" -time -node 10101 -dof 1 2 3 vel;

#---------- Right B.C (ele 100,5100,10000 / node 101,5151 10201)-----------------------
recorder Element -file "Stress/10msoil/ele100_stress_Side_P.out" -time -ele 100 material 1 stress
recorder Element -file "Stress/10msoil/ele5100_stress_Side_P.out" -time -ele 5100 material 1 stress
recorder Element -file "Stress/10msoil/ele10000_stress_Side_P.out" -time -ele 10000 material 1 stress

recorder Node -file "Velocity/10msoil/node101_vel_Side_P.out" -time -node 101 -dof 1 2 3 vel;
recorder Node -file "Velocity/10msoil/node5151_vel_Side_P.out" -time -node 5151 -dof 1 2 3 vel;
recorder Node -file "Velocity/10msoil/node10201_vel_Side_P.out" -time -node 10201 -dof 1 2 3 vel;

#---------- Center Element/Node (ele 51,5051,9951 / node 51,5101,10151) -----------------------
recorder Element -file "Stress/10msoil/ele51_stress_Side_P.out" -time -ele 51 material 1 stress
recorder Element -file "Stress/10msoil/ele5051_stress_Side_P.out" -time -ele 5051 material 1 stress
recorder Element -file "Stress/10msoil/ele9951_stress_Side_P.out" -time -ele 9951 material 1 stress

recorder Node -file "Velocity/10msoil/node51_vel_Side_P.out" -time -node 51 -dof 1 2 3 vel;
recorder Node -file "Velocity/10msoil/node5101_vel_Side_P.out" -time -node 5101 -dof 1 2 3 vel;
recorder Node -file "Velocity/10msoil/node10151_vel_Side_P.out" -time -node 10151 -dof 1 2 3 vel;
...
recorder mpco "MPCO/Pwave_10msideBC" -E material.stress force localforce -N velocity displacement ;#
