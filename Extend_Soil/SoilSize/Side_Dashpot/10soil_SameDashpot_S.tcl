...
recorder Element -file "extend_soil/stress/10m_soil/ele1_stress_Side_S.out" -time -ele 1 material 1 stress
recorder Element -file "extend_soil/stress/10m_soil/ele5001_stress_Side_S.out" -time -ele 5001 material 1 stress
recorder Element -file "extend_soil/stress/10m_soil/ele9901_stress_Side_S.out" -time -ele 9901 material 1 stress

recorder Node -file "extend_soil/velocity/10m_soil/node1_vel_Side_S.out" -time -node 1 -dof 1 2 3 vel;
recorder Node -file "extend_soil/velocity/10m_soil/node5051_vel_Side_S.out" -time -node 5051 -dof 1 2 3 vel;
recorder Node -file "extend_soil/velocity/10m_soil/node10101_vel_Side_S.out" -time -node 10101 -dof 1 2 3 vel;

#---------- Right B.C (ele 100,5100,10000 / node 101,5151 10201)-----------------------
recorder Element -file "extend_soil/stress/10m_soil/ele100_stress_Side_S.out" -time -ele 100 material 1 stress
recorder Element -file "extend_soil/stress/10m_soil/ele5100_stress_Side_S.out" -time -ele 5100 material 1 stress
recorder Element -file "extend_soil/stress/10m_soil/ele10000_stress_Side_S.out" -time -ele 10000 material 1 stress

recorder Node -file "extend_soil/velocity/10m_soil/node101_vel_Side_S.out" -time -node 101 -dof 1 2 3 vel;
recorder Node -file "extend_soil/velocity/10m_soil/node5151_vel_Side_S.out" -time -node 5151 -dof 1 2 3 vel;
recorder Node -file "extend_soil/velocity/10m_soil/node10201_vel_Side_S.out" -time -node 10201 -dof 1 2 3 vel;

#---------- Center Element/Node (ele 51,5051,9951 / node 51,5101,10151) -----------------------
recorder Element -file "extend_soil/stress/10m_soil/ele51_stress_Side_S.out" -time -ele 51 material 1 stress
recorder Element -file "extend_soil/stress/10m_soil/ele5051_stress_Side_S.out" -time -ele 5051 material 1 stress
recorder Element -file "extend_soil/stress/10m_soil/ele9951_stress_Side_S.out" -time -ele 9951 material 1 stress

recorder Node -file "extend_soil/velocity/10m_soil/node51_vel_Side_S.out" -time -node 51 -dof 1 2 3 vel;
recorder Node -file "extend_soil/velocity/10m_soil/node5101_vel_Side_S.out" -time -node 5101 -dof 1 2 3 vel;
recorder Node -file "extend_soil/velocity/10m_soil/node10151_vel_Side_S.out" -time -node 10151 -dof 1 2 3 vel;
...
recorder mpco "extend_soil/MPCO/Swave_10msideBC" -E material.stress force localforce -N velocity displacement ;#
