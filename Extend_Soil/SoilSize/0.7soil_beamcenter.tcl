...
#-------------  P wave ------------------------- 
    ...
    # load 816 0 $p 0
    # load 817 0 $p 0
    load 811 0 [expr (2*0.1)/7] 0
    load 813 0 [expr (2*0.1)/7] 0
    load 815 0 [expr (2*0.1)/7] 0
    load 817 0 [expr (2*0.1)/7] 0
    load 819 0 [expr (2*0.1)/7] 0
    load 821 0 [expr (2*0.1)/7] 0
    load 823 0 [expr (2*0.1)/7] 0
